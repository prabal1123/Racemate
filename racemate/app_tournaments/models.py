...
class Tournament(models.Model):
    ...
    # Public, unguessable identifier used in this tournament's shareable,
    # whole-tournament registration link: /register/tournament/<uuid>/
    uuid = models.UUIDField(
        default=uuid.uuid4,
        blank=True,
        editable=False,
        help_text="Public identifier used in this tournament's shareable registration link.",
    )
    ...
    def registration_path(self):
        """
        Relative URL for this tournament's public registration page.
        Shows a picker of this tournament's own categories only.
        """
        return reverse(
            "accounts:register_tournament",
            kwargs={"tournament_uuid": self.uuid},
        )
...
class TournamentCategory(models.Model):
    ...
    # Public, unguessable identifier used in this category's shareable,
    # single-category registration link: /register/tournament-category/<uuid>/
    uuid = models.UUIDField(
        default=uuid.uuid4,
        unique=True,
        editable=False,
    ...
    def registration_path(self):
        """Relative URL for this category's public, single-category registration page."""
        return reverse("accounts:register_tournament_category", kwargs={"category_uuid": self.uuid})
